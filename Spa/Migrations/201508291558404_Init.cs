    ...
    public partial class Init : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("catalog.Products", t => t.ProductId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ProductVideo", "ProductId", "catalog.Products");
            DropForeignKey("dbo.ProductPhotos", "ProductId", "catalog.Products");
            DropForeignKey("dbo.Offers", "ProductId", "catalog.Products");
            ...
            DropForeignKey("dbo.Ratios", "ProductId", "catalog.Products");
            DropForeignKey("dbo.Ratios", "CustomerId", "dbo.AspNetUsers");
            DropForeignKey("dbo.OrderItems", "ProductId", "catalog.Products");
            ...
            DropForeignKey("dbo.ProductCategories", "ProductId", "catalog.Products");
